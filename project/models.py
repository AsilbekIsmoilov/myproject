...
class QuarterScores(models.Model):
    operator = models.ForeignKey(CallData, on_delete=models.CASCADE, related_name='Quarter Scores +')
    name = models.CharField(max_length=255,null=True)
    group = models.CharField(max_length=255,null=True)

    quarterscore1 = models.DecimalField(max_digits=5, decimal_places=1,null=True)
    quarterscore2 = models.DecimalField(max_digits=5, decimal_places=1,null=True)
    quarterscore3 = models.DecimalField(max_digits=5, decimal_places=1,null=True)
    quarterscore4 = models.DecimalField(max_digits=5, decimal_places=1,null=True)
    ...
    bigmis1 = models.IntegerField(null=True, blank=True)
    bigmis2 = models.IntegerField(null=True, blank=True)
    bigmis3 = models.IntegerField(null=True, blank=True)
    bigmis4 = models.IntegerField(null=True, blank=True)

    mis1 = models.IntegerField(null=True, blank=True)
    mis2 = models.IntegerField(null=True, blank=True)
    mis3 = models.IntegerField(null=True, blank=True)
    mis4 = models.IntegerField(null=True, blank=True)

    smallmis1 = models.IntegerField(null=True, blank=True)
    smallmis2 = models.IntegerField(null=True, blank=True)
    smallmis3 = models.IntegerField(null=True, blank=True)
    smallmis4 = models.IntegerField(null=True, blank=True)
